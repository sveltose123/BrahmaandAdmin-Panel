...
class AddBasedcategory extends React.Component {
    constructor (props) {
        super(props);
        this.state = {
            title: "",
    ...
    submitHandler = (e) => {
        ...
        axiosConfig
            ...
            .then((response) => {
                console.log(response);
                this.props.history.push("/app/brahmaand/sponsor/basedCategory");
                        ...
                        <Route
                            render={({ history }) => (
                                <Button
                                    ...
                                    onClick={() => history.push("/app/brahmaand/sponsor/basedCategory")}
                                >
                                    Back
                                </Button>
                            )}
...
export default AddBasedcategory;
