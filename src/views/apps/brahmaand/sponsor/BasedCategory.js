...
class BasedCategory extends React.Component {
    state = {
        rowData: [],
                            ...
                            <Route
                                render={({ history }) => (
                                    <Button
                                        ...
                                        onClick={() => history.push("/app/brahmaand/sponsor/addBasedcategory")}
                                    >
                                        Add Based Category
                                    </Button>
                                )}
