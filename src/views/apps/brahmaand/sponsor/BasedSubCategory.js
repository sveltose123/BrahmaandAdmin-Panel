...
class BasedSubCategory extends React.Component {
    state = {
        rowData: [],
                            ...
                            <Route
                                render={({ history }) => (
                                    <Button
                                        ...
                                        onClick={() => history.push("/app/brahmaand/sponsor/addBasedSubcategory")}
                                    >
                                        Add Based On Subcategory
                                    </Button>
                                )}
                            />
                        </Col>
...
export default BasedSubCategory;
