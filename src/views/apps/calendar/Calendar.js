...
import {
  fetchEvents, handleSidebar, addEvent, handleSelectedEvent, updateEvent, updateDrag, updateResize
    ...
    return (
      <div className="calendar-header mb-2 d-flex justify-content-between flex-wrap">
        ...
        {/* <div className="text-center view-options mt-1 mt-sm-0 ml-lg-5 ml-0">
          {/* <ButtonGroup>
            <button
              className={`btn ${this.props.view === "month"
                ? "btn-primary"
        ...
        {/* <button
              className={`btn ${this.props.view === "week"
                ? "btn-primary"
                : "btn-outline-primary text-primary"
                }`}
              onClick={() => {
        ...
        {/* <button
              className={`btn ${this.props.view === "day"
                ? "btn-primary"
                : "btn-outline-primary text-primary"
                }`}
              onClick={() => {
