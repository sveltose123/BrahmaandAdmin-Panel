...
class TankList extends React.Component {
          ...
          return (
            <div className="actions cursor-pointer">
              ...
              <Edit
                ...
                color="blue"
                size={20}
                onClick={() => history.push(`/app/setting/tank/editTank/${params.data._id}`)}
              />
              <Trash2
                size={20}
                color="red"
  ...
  async componentDidMount() {
    await axios.get(`http://3.108.185.7/nodejs/api/dealer/gettank`).then((response) => {
              ...
              <Row className="m-2">
                ...
                <Col>
                  <Button
                    ...
                    onClick={() => history.push("/app/setting/tank/addTank")}
                  >
                   ADD Tank
                  </Button>
                </Col>
