            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId="1">
                <Row>
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="primary">  BRAHMAAND</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="success">  BRAHMAAND</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="info">  BRAHMAAND</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="danger">  BRAHMAAND</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="warning">  BRAHMAAND</ToastHeader>
                      <ToastBody>
                  ...
                  <Col md="6" sm="12">
                    <Toast>
                      <ToastHeader icon="dark">  BRAHMAAND</ToastHeader>
                      <ToastBody>
